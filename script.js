...
const translations = {
  en: {
    ...
    "about.p2": "My technical core is <strong>Python (FastAPI/Django)</strong>, REST APIs, <strong>PostgreSQL / SQLAlchemy</strong>, <strong>Docker</strong> and deployment on <strong>GCP</strong>. I integrate <strong>LLMs into production flows</strong> — not demos — with authentication, automated testing (pytest) and solid engineering practices. I'm currently expanding this profile toward Cloud/DevOps with the <strong>AWS SAA</strong> certification, <strong>Terraform</strong> and <strong>Kubernetes</strong>.",
  ...
  fr: {
    ...
    "about.p2": "Mon cœur technique, c'est <strong>Python (FastAPI/Django)</strong>, les API REST, <strong>PostgreSQL / SQLAlchemy</strong>, <strong>Docker</strong> et le déploiement sur <strong>GCP</strong>. J'intègre des <strong>LLM dans des flux de production</strong> — pas des démos — avec authentification, tests automatisés (pytest) et de bonnes pratiques d'ingénierie. J'élargis actuellement ce profil vers le Cloud/DevOps avec la certification <strong>AWS SAA</strong>, <strong>Terraform</strong> et <strong>Kubernetes</strong>.",
  ...
  es: {
    ...
    "about.p2": "Mi núcleo técnico es <strong>Python (FastAPI/Django)</strong>, APIs REST, <strong>PostgreSQL / SQLAlchemy</strong>, <strong>Docker</strong> y despliegue en <strong>GCP</strong>. Integro <strong>LLM en flujos de producción</strong> —no en demos— con autenticación, tests automatizados (pytest) y buenas prácticas de ingeniería. Estoy ampliando este perfil hacia Cloud/DevOps con la certificación <strong>AWS SAA</strong>, <strong>Terraform</strong> y <strong>Kubernetes</strong>.",
